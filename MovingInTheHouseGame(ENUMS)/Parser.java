        ...
        if(tokenizer.hasNext()) {
            ...
            switch (word) {
                ...
                if(tokenizer.hasNext())
                {
                    ...
                    switch(word2) {
                        case "egg": return (GameMain ui, Game game)-> game.take(Item.EGG)+ game.look();
                        case "flour": return (GameMain ui, Game game)-> game.take(Item.FLOUR)+ game.look();
                        case "sugar":return (GameMain ui, Game game)-> game.take(Item.SUGAR)+ game.look();
                    }
                }
                break;
                case "help" : return (GameMain ui, Game game) -> game.help() + ui.getCommands();
                case "quit" : return (GameMain ui, Game game) -> game.quit();
                case "look" : return (GameMain ui, Game game) -> game.look()+ ui.getCommands();
